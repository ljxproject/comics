...
from api.views import ComicInfoViewSet, get_comics_detail, \
    ...
    ChapterInfoViewSet, IndexComicsListViewSet, OwnCollectPostViewSet, OwnCollectListViewSet
...
urlpatterns = [
    ...
    url(r'^(?i)own-coll-coms/$', OwnCollectPostViewSet.as_view({'post': 'post'}), name='get_coll_comics'),
    url(r'^(?i)own-coll-coms-list/$', OwnCollectListViewSet.as_view({'post': 'post'}), name='get_coll_comics_list'),
    ...
    url(r'^index/$', IndexComicsListViewSet.as_view({'post': 'post'}), name="get_index"),
